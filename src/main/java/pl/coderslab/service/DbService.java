...
public class DbService {
    ...
    public static String dbName = "Warsztat_samochodowy";
    private static String dbUser = "root";
    private static String dbPass = "root";

    private static Connection createConn() throws SQLException {
        String connUrl = "jdbc:mysql://localhost:3306/Warsztat_samochodowy?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&useSSL=false";
        return DbUtil.getConn();//DriverManager.getConnection(connUrl, dbUser, dbPass);
    }
     ...
     * @throws SQLException
     */
    public static Integer insertIntoDatabase(String query, List<String> params, String[] generatedColumns) throws SQLException {
